...
// I'll append it just before `// Helper to map roles` if it exists, or just before the final `}`
// Let's find the closing brace of main()
// But wait, the easiest way is to append right before the final catch or finally of main() if any, or just before module.exports
...
// Insert it right before `} catch (e) {` which is at the end of `main()`
content = content.replace(/} catch \(e\) {/, newData + "\n} catch (e) {");

fs.writeFileSync(seedPath, content, 'utf8');
console.log('Appended connections and service requests to seed.js');
